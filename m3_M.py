...
def main(resampler, err_percentile, plot_results):
    ...
    if plot_results:
        ...
        importance_file = "figs/features_importances_" + str(resampler) + "_M3.pdf"
        ...
        shap_file = "figs/shap_" + str(resampler) + "_M3.pdf"
